...
namespace agrobus::isobus::fs {
    ...
    enum class FSError : u8 {
        ...
        EndOfFile = 45,       // End of file reached
    ...
    inline OpenFlags get_access_mode(OpenFlags flags) { return static_cast<OpenFlags>(static_cast<u8>(flags) & 0x03); }
